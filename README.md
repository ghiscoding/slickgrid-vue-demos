...
| ------------ | ------- | ----------- |
| [@slickgrid-universal/vue-row-detail-plugin](https://github.com/ghiscoding/slickgrid-universal/blob/master/frameworks-plugins/vue-row-detail-plugin) | [![npm](https://img.shields.io/npm/v/@slickgrid-universal/vue-row-detail-plugin.svg?color=forest)](https://www.npmjs.com/package/@slickgrid-universal/vue-row-detail-plugin) | Row Detail plugin |
